...
# SECRET_KEY = 'django-insecure-uvz+j4gaxc(_zc-u95=))rc1$c*!qqf3@*+3eej$4+@looznud'
SECRET_KEY = os.getenv('SECRET_KEY')

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = os.getenv('DEBUG')

CSRF_TRUSTED_ORIGINS = ['https://sec-msg-afaggyhgfsfkfpgq.centralindia-01.azurewebsites.net', 'https://messaging-room.onrender.com','https://*.127.0.0.1']
